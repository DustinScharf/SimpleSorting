  ...
  */
  public static void main (String arg[]){
    ...
    while (true){
      ...
      switch (auswahl){
          case 1:s.bs = new BubbleSort(s.ds,s.bsWait);
                 s.messeZeit(auswahl);
                 s.ds.bs = s.bs;
                 ...
                 break;
          case 2:s.bks = new BucketSort(s.ds,s.bksWait);
                 s.messeZeit(auswahl);
                 s.ds.bks = s.bks;
                 ...
                 break;
          case 3:s.hs = new HeapSort(s.ds,s.hsWait);
                 s.messeZeit(auswahl);
                 s.ds.hs = s.hs;
                 ...
                 break;
          case 4:s.is = new InsertionSort(s.ds,s.isWait);
                 s.messeZeit(auswahl);
                 s.ds.is = s.is;
                 ...
                 break;
          case 5:s.ms = new MergeSort(s.ds,s.msWait);
                 s.messeZeit(auswahl);
                 s.ds.ms = s.ms;
                 ...
                 break;
          case 6:s.qs = new QuickSort(s.ds,s.qsWait);
                 s.messeZeit(auswahl);
                 s.ds.qs = s.qs;
                 ...
                 break;
          case 7:s.ses = new SelectionSort(s.ds,s.sesWait);
                 s.messeZeit(auswahl);
                 s.ds.ses = s.ses;
                 ...
                 break;
          case 8:s.shs = new ShellSort(s.ds,s.shsWait);
                 s.messeZeit(auswahl);
                 s.ds.shs = s.shs;
