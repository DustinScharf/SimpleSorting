 ...
 */
  private void starteSortierung(){
     switch(aktiverAlg){
       case 1:bs.start();break;
       case 2:bks.start();break;
       case 3:hs.start();break;
       case 4:is.start();break;
       case 5:ms.start();break;
       case 6:qs.start();break;
       case 7:ses.start();break;
       case 8:shs.start();break;
     }
  }
/**
 ...
 */
  private void halteSortierungAn(){
     switch(aktiverAlg){
       case 1:bs.suspend();break;
       case 2:bks.suspend();break;
       case 3:hs.suspend();break;
       case 4:is.suspend();break;
       case 5:ms.suspend();break;
       case 6:qs.suspend();break;
       case 7:ses.suspend();break;
       case 8:shs.suspend();break;
     }
  }
/**
 ...
 */
  private void setzeSortierungFort(){
     switch(aktiverAlg){
       case 1:bs.resume();break;
       case 2:bks.resume();break;
       case 3:hs.resume();break;
       case 4:is.resume();break;
       case 5:ms.resume();break;
       case 6:qs.resume();break;
       case 7:ses.resume();break;
       case 8:shs.resume();break;
     }
  }
/**
 ...
 */
  public void beendeSortierung(){
     switch(aktiverAlg){
       case 1:bs.resume();bs.stopp = true;break;
       case 2:bks.resume();bks.stopp = true;break;
       case 3:hs.resume();hs.stopp = true;break;
       case 4:is.resume();is.stopp = true;break;
       case 5:ms.resume();ms.stopp = true;break;
       case 6:qs.resume();qs.stopp = true;break;
       case 7:ses.resume();ses.stopp = true;break;
       case 8:shs.resume();shs.stopp = true;break;
     }
  }
/**
